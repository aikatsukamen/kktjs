...
(function (window, document) {
  ...
  ath.intl = {
    ...
    en_us: {
      ios: "<h2>Install kktjs App</h2>To add this web app to the home screen: tap %icon and then <strong>Add to Home Screen</strong>.",
      android: "<h2>Install kktjs App</h2>To add this web app to the home screen open the browser option menu and tap on <strong>Add to homescreen</strong>. <small>The menu can be accessed by pressing the menu hardware button if your device has one, or by tapping the top right menu icon %icon.</small>"
    },
    es_es: {
    ...
    ja_jp: {
      ios: '<h2>Install kktjs App</h2>Webアプリとして使えるように、<br>%iconを押して<strong>ホーム画面に追加</strong>から<br>インストールしてね。<br> <br>ホーム画面から起動すると、<br>新しいデザインでキラキラッターを楽しめるよ。',
      android: '<h2>Install kktjs App</h2>Webアプリとして使えるように、<br>ブラウザのオプションメニューから<strong>ホーム画面に追加</strong>から<br>インストールしてね。<br>ホーム画面から起動すると、新しいデザインのキラキラッターを楽しめるよ。<small>オプションメニューは、右上のメニューアイコン<span class="ath-action-icon">icon</span>を押すと表示できる...かな。</small>',
    },
    ko_kr: {
